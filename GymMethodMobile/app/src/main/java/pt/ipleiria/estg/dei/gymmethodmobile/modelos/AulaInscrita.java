...
public class AulaInscrita implements Serializable
{
    public static ArrayList<AulaInscrita> aulasInscritasList = new ArrayList<>();
    ...
    public AulaInscrita(int id, int inscricao_id, String nome, LocalDate data, LocalTime inicio, LocalTime fim, String status)
    {
        this.id = id;
